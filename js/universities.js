// This script generates an interactive bar chart using SVG and D3 for the universities found in the Zenodo database. It requires the universities.json
...
var legtypes = ["US","GB","CH","FI","CN","BR"];
...
var tip = d3.tip().attr("class", "d3-tip")
    .html(function (d) {
        var info = "University: <span style='color:grey'>" + d.affiliation + "</span><br />";
...
.on("click", function () {
    filter_month = '2009-07';
	n = 20;
    d3.json("data/universities.json", function (data) {
...
document.getElementById("title_div").innerHTML = 'Publications by University (' + firstDate + ' to ' + lastDate + ')';
...
function resource_filter(d) {
    return d.month == filter_month && d.affiliation != "All";
};
...
function update(data) {
	...
	for (var i = 0; i < arrayLength; i++) {
		...
		}).addTo(layerGroup).bindPopup("<b>University:</b> " + temp_obj.affiliation + 
